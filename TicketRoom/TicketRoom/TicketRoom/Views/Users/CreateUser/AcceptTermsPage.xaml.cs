    ...
    public partial class AcceptTermsPage : ContentPage
    {
        ...
        private void CheckContent_Clicked(object sender, EventArgs e)
        {
            if (Global.isaccepttermsnextbtn_clicked)
            {
                ...
                else if (c.Text.Equals("전자금융 거래 이용약관 동의"))
                {
        ...
        {
            DisplayAlert("", "정보통신망 이용촉진 및 정보보호 등에 관한 법률에는 만 14미만 아동의 개인정보 수집시 법정 대리인 동의를 받도록 규정하고 있으며, 만 14세 미만 아동이 법정대리인 동의없이 회원가입을 하는 경우 회원탈퇴 또는 서비스 이용이 제한 될 수 있습니다. ", "ok");
        }
